...
dataset = numpy.zeros((20035,imgMat.shape[0], imgMat.shape[1], 4),dtype=numpy.float)



for k in range(0,20035):
    Img_FileName = 'img/patchImg%04d.bmp' % (k)
    Depth_FileName = 'depth_txt/patchDepth%04d.txt' % (k)
    print(DS_Path+Img_FileName)
